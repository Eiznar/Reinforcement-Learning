...
import torch
import numpy as np
from model.model import ConnectNet
from board.connect4board import Board as cboard
import board.encoder_decoder_c4 as ed
import copy
...
if __name__ == "__main__":
    best_net="cc4_current_net__iter0.pth.tar"
